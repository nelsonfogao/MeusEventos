package com.project.meuseventos.ui.cadastro
...
class CadastroFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        buttonCadastroCadastrar.setOnClickListener {

            val senha = editTextCadastroPassword.text.toString()
            val resenha = editTextCadastroRePassword.text.toString()
